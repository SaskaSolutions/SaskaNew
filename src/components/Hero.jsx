...
//     const fastY = useTransform(scrollYProgress, [0, 1], [200, -1000]);
...
//                 <div ref={ref} className='w-full h-[250vh] relative max-w-[1600px] mx-auto'>
//                     <motion.div
//                         initial="hide"
//                         animate="show"
...
//                     {/* Slow moving squares */}
//                     <motion.div className='shadow-md shadow-violet-700/10 w-[400px] h-[250px] absolute bottom-[20%] lg:bottom-[40%] right-[15%] z-[5] opacity-60' >
...
//                     </motion.div>
//                     <motion.div className='shadow-md shadow-violet-700/10 w-[400px] h-[250px] absolute bottom-[60%] lg:bottom-[45%] left-[15%] z-[5] opacity-60' >
...
//                 <div className="size-40 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full filter blur-xl opacity-50"></div>
//             </div>
//             <div className="absolute bottom-52 right-24">
//                 <div className="size-28 bg-gradient-to-r from-pink-500 to-red-500 rounded-full filter blur-xl opacity-50"></div>
//             </div>
//         </div>
//     );
// };
...
const Hero = () => {
    ...
    return (
        <div className='relative'>
            <div className='h-[200vh] w-full bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden'>
                <div ref={ref} className='w-full h-[200vh] relative max-w-[1600px] mx-auto'>
                    ...
                    >
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="font-Poppins whitespace-nowrap bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 px-10 py-4 rounded-full font-bold hover:scale-110 text-lg mt-4 text-white shadow-xl transition-transform"
                        >
                            Get Started
                        </motion.button>
                    </motion.div>
                    ...
                    {/* Slow-moving squares */}
                    <motion.div className='shadow-md shadow-violet-700/10 w-[400px] h-[250px] absolute bottom-[20%] lg:bottom-[30%] right-[10%] z-[5] opacity-60' >
                        <img src="https://plus.unsplash.com/premium_photo-1683140655656-20448abc55da?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-full w-full object-center object-cover' />
                    </motion.div>
                    <motion.div className='shadow-md shadow-violet-700/10 w-[400px] h-[250px] absolute bottom-[50%] left-[5%] z-[5] opacity-60' >
                        <img src="https://plus.unsplash.com/premium_photo-1661320832191-8e9866f34bc9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-full w-full object-center object-cover' />
                    </motion.div>

                    {/* Fast-moving squares */}
                    <motion.div className='shadow-md shadow-violet-700/10 w-[300px] h-[250px] absolute bottom-[25%] right-[20%] z-[10] lg:block hidden' style={{ y: fastY }} >
                    ...
                    <motion.div className='shadow-md shadow-violet-700/10 w-[350px] h-[200px] absolute bottom-[40%] left-[10%] z-[10]' style={{ y: fastY }} >
                        <img src="https://plus.unsplash.com/premium_photo-1663050633633-2856e875dcc7?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-full w-full object-center object-cover' />
                    </motion.div>
                    <motion.div className='shadow-md shadow-violet-700/10 w-[300px] h-[150px] absolute bottom-[10%] right-[5%] z-[10] lg:block hidden' style={{ y: fastY }} >
                    ...
                    <motion.div className='shadow-md shadow-violet-700/10 w-[250px] h-[350px] absolute bottom-[5%] left-[20%] z-[10] lg:block hidden' style={{ y: fastY }} >
                        <img src="https://images.unsplash.com/photo-1668554245893-2430d0077217?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-full w-full object-center object-cover' />
                    </motion.div>
                </div>
            </div>
